...
├── lean-toolchain           # Lean version specification (v4.23.0)
...
- The library uses mathlib v4.23.0 - ensure compatibility when adding dependencies
...
## Dependencies
- **mathlib**: v4.23.0 (large library, causes long download times)
- **doc-gen4**: v4.23.0 branch (for documentation generation)
