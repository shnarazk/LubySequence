...
├── lean-toolchain           # Lean version specification (v4.25.0-rc1)
...
- The library uses mathlib v4.25.0-rc1 - ensure compatibility when adding dependencies
...
## Dependencies
- **mathlib**: v4.25.0-rc1 (large library, causes long download times)
- **doc-gen4**: main branch (for documentation generation)
- **Lean**: v4.25.0-rc1 (specified in lean-toolchain)
