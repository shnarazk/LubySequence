...
├── lean-toolchain           # Lean version specification (v4.25.0-rc2)
...
- The library uses mathlib v4.25.0-rc2 - ensure compatibility when adding dependencies
...
## Dependencies
- **mathlib**: v4.25.0-rc2 (large library, causes long download times)
- **doc-gen4**: main branch (for documentation generation)
- **Lean**: v4.25.0-rc2 (specified in lean-toolchain)
